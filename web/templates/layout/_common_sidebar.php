<div id="common-sidebar">
	<ul>
		...
		<li><a id="downloads-link" href='<?php echo url_for("/downloads/"); ?>'><span>Downloads</span>下载</a></li>
		<li><a id="events-link" href='<?php echo url_for("/events/"); ?>'><span>Events</span>事记</a></li>
		<li><a id="search-link" href='<?php echo url_for("/search/"); ?>'><span>Search</span>搜索</a></li>
	</ul>
</div>
